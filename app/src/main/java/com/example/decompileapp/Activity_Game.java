package com.example.decompileapp;
...
public class Activity_Game extends AppCompatActivity {
    ...
    private void findViews() {
        this.arrows = new ImageButton[]{findViewById(R.id.game_BTN_left), findViewById(R.id.game_BTN_right), (ImageButton) findViewById(R.id.game_BTN_up), (ImageButton) findViewById(R.id.game_BTN_down)};
    }
}
